...
%-----------EDUCATION-----------------
\section{Profile}
      Polyglot software developer with 8+ years of experience in web development and big data.

      Writing Go for the better part of past 4 years.
...
\resumeSubHeadingListStart
    \resumeSubheading
	  ...
	  Developed and enhanced core business products as part of a small but highly efficient team.

		\labelitemii \ Continued the design and implementation of a workflow engine with state management provided by Temporal.

		\labelitemii \ Developed in-house modules to gradually replace Temporal.

		\labelitemii \ Integrated external data sources with the workflow engine.

		\labelitemii \ Added the ability to declare agentic AI implementations in the workflow engine.

		\labelitemii \ Efficiently migrated projects from Python to Go by employing highly customized code generation.
	}
      \resumeItemListEnd
    \resumeSubheading
      {eSolutions}{}
...
\section{Programming Skills}
  \resumeSubHeadingListStart
    ...
    \item{
      \textbf{Relevant technologies}{: Kafka, Temporal, Spring Framework, Spark, Angular, Hadoop, Keycloak, Cassandra, NiFi, NodeRED, AWS SQS, AWS DynamoDB}
    }
    \item{
