...
\section{Profile}
      ...
      I enjoy creating simple solutions for complex problems. 
...
\resumeSubHeadingListStart
	...
	\resumeItem{Go web development}{
	  ...
	  \labelitemii \ Promoted Go internally via two ligthning talks (30 min) and a one week full-day Go workshop/course.

	  \labelitemii \ Set up infrastructure (gitlab pipeline to build, test, lint, deploy) for an internal Go-based project and did mentored the team members on said project.
	}
        \resumeItem{Big Data}{
